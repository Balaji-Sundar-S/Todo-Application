...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AuthEntity? data) data,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AuthEntity? data)? data,
...
class _$AuthStateDataImpl implements _AuthStateData {
  const _$AuthStateDataImpl(this.data);
...
abstract class _AuthStateData implements AuthState {
  const factory _AuthStateData(final AuthEntity? data) = _$AuthStateDataImpl;
...
abstract class _AuthStateError implements AuthState {
  const factory _AuthStateError({final String? error}) = _$AuthStateErrorImpl;
